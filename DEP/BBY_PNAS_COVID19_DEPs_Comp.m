...
% filesave = [directory, '/Results_BBY_PNAS_COVID_InsideUncertainty_12_deps']; % split-weighted prior (1), uncertainty averse (2)
% filesave = [directory, '/Results_BBY_PNAS_COVID_InsideUncertainty_22_deps']; % over-weighted prior (2), uncertainty averse (2)
% filesave = [directory, '/Results_BBY_PNAS_COVID_InsideUncertainty_32_deps']; % under-weighted prior (3), uncertainty averse (2)
...
ax = gca;
ax.YAxis.Exponent = 0;
%     print('covid_RR_DEPs_SA_Split','-dpng')    
